...
|-----------|--------|----------------|-------|
| Log4j | shop | 2.17.1 | ✅ Critical CVEs remediated (upgraded from 2.6.1) |
...
- **Security Risk**: The SQL injection vulnerability in the instruments module poses an immediate security concern. The Log4j vulnerability has been remediated by upgrading to 2.17.1 (see [PR #31](https://github.com/magnefique-studios/instrumentShop/pull/31))

...
| Log4j | test | ~~2.6.1~~ → 2.24.3 | ✅ Remediated per PR #27 (CVE-2021-44228, CVE-2021-45046, CVE-2017-5645) |
...
- **Security Risk**: The Log4j 2.6.1 dependency in the `shop` module and SQL injection vulnerability pose immediate security concerns. The `test` module's Log4j has been remediated to 2.24.3 (PR #27)

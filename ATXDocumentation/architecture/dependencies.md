...
> **Note**: The `test` module's log4j dependencies were upgraded from 2.6.1 to 2.17.1 via [PR #34](https://github.com/magnefique-studios/instrumentShop/pull/34) to remediate CVE-2017-5645.

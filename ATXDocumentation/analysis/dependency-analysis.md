...
| 🟡 Outdated | 6 | Log4j 2.6.1 (shop only), Spring Boot 2.7.x, JUnit 3.8.1, OTel alpha, Cucumber 1.2.5, commons-httpclient 3.1 (test) |
| 🟢 Current/Acceptable | 6+ | Spring Boot 3.2.2, OTel 2.2.0, PostgreSQL driver (managed), Log4j 2.17.1 (test module — upgraded from 2.6.1 via PR #34) |

...
2. ~~**Log4j 2.6.1** (shop) — Medium — Vulnerable to Log4Shell RCE~~ ✅ **Remediated** — shop module upgraded to Log4j 2.17.1 via [PR #30](https://github.com/magnefique-studios/instrumentShop/pull/30). **Note**: test module still uses Log4j 2.6.1.

...
1. **Log4j 2.6.1** — `shop` module (only — `test` module remediated to 2.17.1 via PR #34) — critically outdated, vulnerable to Log4Shell (CVE-2021-44228)
